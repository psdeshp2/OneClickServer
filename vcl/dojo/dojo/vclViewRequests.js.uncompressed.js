...
if(!dojo._hasResource["vcldojo.HoverTooltip"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
dojo.i18n._preloadLocalizations("dojo.nls.vclViewRequests", ["ROOT","ar","ca","cs","da","de","de-de","el","en","en-gb","en-us","es","es-es","fi","fi-fi","fr","fr-fr","he","he-il","hu","it","it-it","ja","ja-jp","ko","ko-kr","nb","nl","nl-nl","pl","pt","pt-br","pt-pt","ru","sk","sl","sv","th","tr","xx","zh","zh-cn","zh-tw"]);
